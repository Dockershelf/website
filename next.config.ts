...
const config: NextConfig = {
  ...
  async headers() {
    return [
      ...
      // Blog posts: short browser cache; long CDN TTL with tag purge on edit
      {
        source:
      ...
      // OSS placeholder pages (replaces former portfolio/case-study cache tags)
      {
        source: "/overview",
        headers: [
          {
      ...
      // R12: discovery static surfaces — public + SWR + CDN tags
      {
        source: "/llms.txt",
        headers: [
          {
